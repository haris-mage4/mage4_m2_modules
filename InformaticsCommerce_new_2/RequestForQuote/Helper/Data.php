...
namespace InformaticsCommerce\RequestForQuote\Helper;
...
class Data extends AbstractHelper
{
    ...
    public function __construct(Session $session, Configurable $configurableProduct, ProductRepository $productRepository, ImageHelper $imageHelper, ProductFactory $productFactory, Config $eavConfig, PriceHelper $priceHelper, StoreManagerInterface $storeManager, DirectoryList $directoryList, Filesystem $filesystem, Registry $registry, Context $context)
    {

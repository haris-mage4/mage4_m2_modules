<?php
namespace Mage4\TilesGallery\Block\Adminhtml\Widget;
...
class ImageChooser extends \Magento\Backend\Block\Template
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $element->setData('after_element_html', $input->getElementHtml() . $chooser->toHtml() . "<script>require(['mage/adminhtml/browser']);</script>");        return $element;
    }
}

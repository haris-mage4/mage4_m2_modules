...
use InformaticsCommerce\UseMyShippingAccount\Api\Data\DataSearchResultsInterfaceFactory;
use InformaticsCommerce\UseMyShippingAccount\Model\ResourceModel\Data as ResourceData;
use InformaticsCommerce\UseMyShippingAccount\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($Id)
    {
        if (!isset($this->instances[$Id])) {
            /** @var \InformaticsCommerce\UseMyShippingAccount\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \InformaticsCommerce\UseMyShippingAccount\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \InformaticsCommerce\UseMyShippingAccount\Model\ResourceModel\Data\Collection $collection */

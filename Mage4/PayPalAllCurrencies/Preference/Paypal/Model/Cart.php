...
namespace Mage4\PayPalAllCurrencies\Preference\Paypal\Model;

/**
 * Class Cart
 *
 * @package \Mage4\PayPalAllCurrencies\Model\Preference\Paypal
 */
class Cart extends \Magento\Paypal\Model\Cart
{
    ...
    public function __construct(
        ...
        $salesModel,
        \Mage4\PayPalAllCurrencies\Helper\Data $helper
    ) {
    ...
    protected function _importItemsFromSalesModel()
    {
        if ($this->helper->isModuleEnabled()) {
            ...
            /** @TODO-Mage4: check this, when data will be saved in order and for instanceof \Magento\Payment\Model\Cart\SalesModel\Order */

...
use Mage4\CsvUpload\Api\CsvRepositoryInterface;
use Mage4\CsvUpload\Api\Data\CsvInterfaceFactory;
use Mage4\CsvUpload\Api\Data\CsvSearchResultsInterfaceFactory;
use Mage4\CsvUpload\Model\ResourceModel\Csv as ResourceCsv;
use Mage4\CsvUpload\Model\ResourceModel\Csv\CollectionFactory as CsvCollectionFactory;

/**
 * Mage4 CsvUpload CsvRepository class
 */
class CsvRepository implements CsvRepositoryInterface
{
    ...
    public function save(
        ...
        $csvData = $this->extensibleDataObjectConverter->toNestedArray(
            $csv,
            [],
            \Mage4\CsvUpload\Api\Data\CsvInterface::class
        );

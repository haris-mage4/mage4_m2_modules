...
// define('PRODUCTION_CERTIFICATE_KEY', 'key.pem');
// define('PRODUCTION_CERTIFICATE_PATH', 'BaytoniaCert.pem');

define('PRODUCTION_CERTIFICATE_KEY', 'baytoniaApplePay.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', 'baytoniaApplePay.crt.pem');
...
define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.com.baytonia');
...
define('PRODUCTION_DISPLAYNAME', 'Baytonia');

...
abstract class Bank extends \Baytonia\BankInstallment\Controller\Adminhtml\AbstractAction
{
    ...
    {
        return $this->_authorization->isAllowed('Baytonia_BankInstallment::bankinstallment_banks');
    }
